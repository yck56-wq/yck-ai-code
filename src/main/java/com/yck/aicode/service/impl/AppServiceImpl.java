...
import com.yck.aicode.core.AiCodeGeneratorFacade;
import com.yck.aicode.core.builder.VueProjectBuilder;
import com.yck.aicode.core.handler.StreamHandlerExecutor;
...
import com.yck.aicode.mapper.AppMapper;
import com.yck.aicode.model.enums.ChatHistoryMessageTypeEnum;
...
import com.yck.aicode.service.AppService;
import com.yck.aicode.service.ChatHistoryService;
import com.yck.aicode.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        // 5. 再调用ai前，先保存用户消息到数据库中
        chatHistoryService.addChatMessage(appId, message, ChatHistoryMessageTypeEnum.USER.getValue(), loginUser.getId());
        // 6. 调用 AI 生成代码 (流式)
        Flux<String> codeStream = aiCodeGeneratorFacade.generateAndSaveCodeStream(message, codeGenTypeEnum, appId);
        // 7. 收集 AI 响应的内容，并且再完成对话后保存记录到对话历史中
